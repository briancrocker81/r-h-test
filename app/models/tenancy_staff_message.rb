class TenancyStaffMessage < ApplicationRecord
  belongs_to :tenancy_staff_conversation
  ...
  validates_presence_of :body, :subject, :tenancy_staff_conversation_id, :sender, :receiver
