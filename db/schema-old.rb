...
ActiveRecord::Schema.define(version: 2021_10_09_175608) do
  ...
  create_table "admin_variables", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "compliance_documents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "criminal_records", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "custom_property_reports", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.date "start_date"
    t.date "end_date"
    t.integer "run_by_id"
    t.string "year"
  ...
  create_table "events_properties", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "generic_documents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "document_name"
    t.string "document_file"
    t.date "document_expiry"
    t.boolean "active"
  ...
  create_table "guarantors", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "landlord_documents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "document_name"
    t.string "document_file"
    t.boolean "active", default: true
  ...
  create_table "landlord_staff_conversations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "landlord_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "landlord_staff_messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "body"
    t.text "subject"
    t.string "from"
  ...
  create_table "landlord_statement_reports", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "manage_automation_mails", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "mail_type"
    t.text "mail_methods"
  ...
  create_table "professional_details", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "working_at"
    t.string "job_title"
  ...
  create_table "properties", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "council_tax_reference"
  ...
  create_table "property_expenses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "property_id"
  ...
  create_table "property_list_families", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "property_id"
    t.text "description"
    t.string "location"
    t.string "school"
  ...
  create_table "property_list_graduates", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "property_id"
    t.text "description"
    t.string "location"
  ...
  create_table "property_list_professionals", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "property_id"
    t.text "description"
    t.integer "furnished"
    t.string "location"
  ...
  create_table "property_list_students", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "property_id"
    t.text "description"
    t.string "location"
    t.string "college"
  ...
  create_table "property_reports", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "student_course_details", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "tenancies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.bigint "room_id"
    t.json "secondary_contact_details"
    ...
    t.integer "payment_card_cvc", limit: 3
  ...
  create_table "tenancy_documents", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.string "document_name"
    t.string "document_file"
    t.bigint "tenancy_id"
  ...
  create_table "tenancy_histories", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "tenancy_id"
  ...
  create_table "tenancy_identifications", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "tenancy_id"
    t.integer "staff_id"
  ...
  create_table "tenancy_payment_items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "tenancy_id"
    t.string "item"
    t.string "item_type"
    t.date "due_date"
  ...
  create_table "tenancy_staff_conversations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "tenancy_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "tenancy_staff_messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.text "body"
    t.text "subject"
    t.string "from"
